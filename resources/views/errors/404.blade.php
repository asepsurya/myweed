...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | {{ config('app.name', 'RuangUndang') }}</title>
    <meta name="description" content="Halaman yang Anda cari tidak ditemukan. Kembali ke halaman utama RuangUndang.">
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .error-section {
            ...
            text-align: center;
            background: linear-gradient(rgba(27, 42, 74, 0.85), rgba(27, 42, 74, 0.95)),
                        url('https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=2070&auto=format&fit=crop') center/cover no-repeat;
            color: var(--white);
            position: relative;
            overflow: hidden;
        ...
        .error-emoji {
            font-size: 4rem;
            margin-bottom: 1rem;
            animation: drift 4s ease-in-out infinite, fadeInUp 1s ease-out 0.2s forwards;
            opacity: 0;
        }
        ...
        <div class="container error-content">
            <div class="error-illustration">
                <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="100" cy="100" r="90" stroke="rgba(198,169,98,0.3)" stroke-width="2" stroke-dasharray="8 4"/>
                    <circle cx="100" cy="100" r="70" stroke="rgba(198,169,98,0.2)" stroke-width="1.5" stroke-dasharray="6 3"/>
                    <path d="M70 85 Q75 80 80 85" stroke="#E8D5A3" stroke-width="3" stroke-linecap="round" fill="none"/>
                    <path d="M120 85 Q125 80 130 85" stroke="#E8D5A3" stroke-width="3" stroke-linecap="round" fill="none"/>
                    <path d="M85 130 Q100 115 115 130" stroke="#E8D5A3" stroke-width="3" stroke-linecap="round" fill="none"/>
                    <path d="M100 40 L100 25" stroke="rgba(198,169,98,0.4)" stroke-width="2" stroke-linecap="round"/>
                    <circle cx="100" cy="22" r="4" fill="rgba(198,169,98,0.5)"/>
                </svg>
            </div>
            ...
            <p class="error-desc">
                Oops! Sepertinya Anda tersesat di jalan yang salah. Halaman yang Anda cari mungkin telah dipindahkan, dihapus, atau tidak pernah ada.
            </p>
            <div class="error-actions">
                <a href="{{ route('landing') }}" class="btn-home">
                    <i class="bi bi-house-door"></i> Kembali ke Beranda
                </a>
                <a href="{{ route('pages.bantuan') }}" class="btn-outline-home">
