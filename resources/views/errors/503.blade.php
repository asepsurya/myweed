...
<head>
    ...
    <title>503 - Layanan Tidak Tersedia | {{ config('app.name', 'RuangUndang') }}</title>
    <meta name="description" content="Layanan sedang dalam pemeliharaan. Silakan coba lagi nanti.">
        ...
        * { box-sizing: border-box; }
        ...
        .error-section {
            ...
            background: linear-gradient(rgba(27, 42, 74, 0.88), rgba(27, 42, 74, 0.96)),
                        url('https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?q=80&w=2070&auto=format&fit=crop') center/cover no-repeat;
            color: var(--white);
            position: relative;
            overflow: hidden;
        ...
        .wrench-icon {
            ...
            animation: wrench 3s ease-in-out infinite, fadeInUp 1s ease-out 0.2s forwards;
            opacity: 0;
            margin-bottom: 1rem;
        }
...
<body>
    ...
    <section class="error-section">
        ...
        <div class="container error-content">
            ...
            <p class="error-desc">
                Kami sedang melakukan pemeliharaan rutin untuk meningkatkan kualitas layanan. Sistem akan kembali online dalam waktu dekat. Terima kasih atas kesabaran Anda.
            </p>
