...
<head>
    ...
    <title>403 - Akses Ditolak | {{ config('app.name', 'RuangUndang') }}</title>
        ...
        * { box-sizing: border-box; }
        ...
        .error-section {
            ...
            background: linear-gradient(rgba(27, 42, 74, 0.88), rgba(27, 42, 74, 0.96)),
                        url('https://images.unsplash.com/photo-1563986768609-322da13575f3?q=80&w=2070&auto=format&fit=crop') center/cover no-repeat;
            color: var(--white);
            position: relative;
            overflow: hidden;
        ...
        .lock-icon {
            ...
            animation: shake 2s ease-in-out, fadeInUp 1s ease-out 0.2s forwards;
            opacity: 0;
            margin-bottom: 1rem;
        }
...
<body>
    ...
    <section class="error-section">
        ...
        <div class="container error-content">
            ...
            <p class="error-desc">
                Maaf, Anda tidak memiliki izin untuk mengakses halaman ini. Jika Anda merasa ini adalah kesalahan, silakan hubungi administrator atau kembali ke halaman utama.
            </p>
            <div class="error-actions">
                ...
                <a href="{{ route('pages.bantuan') }}" class="btn-outline-home">
                    <i class="bi bi-headset"></i> Hubungi Support
                </a>
            </div>
        </div>
    </section>
