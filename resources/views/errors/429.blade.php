...
<head>
    ...
    <title>429 - Terlalu Banyak Permintaan | {{ config('app.name', 'RuangUndang') }}</title>
    <meta name="description" content="Anda telah mengirim terlalu banyak permintaan. Silakan tunggu sebentar dan coba lagi.">
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .speed-icon {
            ...
            animation: speedometer 2s ease-in-out infinite, fadeInUp 1s ease-out 0.2s forwards;
            opacity: 0;
            margin-bottom: 1rem;
        }
...
<body>
    ...
    <section class="error-section">
        ...
        <div class="container error-content">
            ...
            <p class="error-desc">
                Whoa! Anda telah mengirim terlalu banyak permintaan dalam waktu singkat. Silakan tunggu sebentar sebelum mencoba lagi. Ini untuk keamanan dan kenyamanan bersama.
            </p>
