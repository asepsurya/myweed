...
<head>
    ...
    <title>419 - Sesi Berakhir | {{ config('app.name', 'RuangUndang') }}</title>
    <meta name="description" content="Sesi Anda telah berakhir. Silakan muat ulang halaman dan coba lagi.">
        ...
        * { box-sizing: border-box; }
        ...
        .error-section {
            ...
            background: linear-gradient(rgba(27, 42, 74, 0.85), rgba(27, 42, 74, 0.95)),
                        url('https://images.unsplash.com/photo-1507925921958-8a62f3d1a50d?q=80&w=2076&auto=format&fit=crop') center/cover no-repeat;
            color: var(--white);
            position: relative;
            overflow: hidden;
        ...
        .clock-icon {
            ...
            animation: tick 2s ease-in-out infinite, fadeInUp 1s ease-out 0.2s forwards;
            opacity: 0;
            margin-bottom: 1rem;
        }
...
<body>
    ...
    <section class="error-section">
        ...
        <div class="container error-content">
            ...
            <p class="error-desc">
                Sesi login Anda telah berakhir karena tidak ada aktivitas dalam waktu lama. Silakan muat ulang halaman dan coba lagi. Data Anda aman.
            </p>
