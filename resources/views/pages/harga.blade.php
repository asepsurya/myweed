...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .comparison-table td i { font-size: 1.1rem; }
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 reveal" style="transition-delay: 0.1s;">
                    <div class="pricing-card">
                        <div class="pricing-header">
                            <div class="pricing-icon"><i class="bi bi-gift"></i></div>
                            <h4>Gratis</h4>
                            <div class="pricing-price">Rp 0<span>/undangan</span></div>
                            <p class="pricing-desc">Cocok untuk yang baru mencoba</p>
                        </div>
                        <ul class="pricing-features">
                            <li><i class="bi bi-check-circle-fill text-gold"></i> 1 Tema Gratis</li>
                            <li><i class="bi bi-check-circle-fill text-gold"></i> 50 Tamu undangan</li>
                            <li><i class="bi bi-check-circle-fill text-gold"></i> RSVP dasar</li>
                            <li><i class="bi bi-check-circle-fill text-gold"></i> Galeri foto 10 slot</li>
                            <li class="disabled"><i class="bi bi-x-circle text-muted-custom"></i> Hapus watermark</li>
                            <li class="disabled"><i class="bi bi-x-circle text-muted-custom"></i> Custom domain</li>
                        </ul>
                        <a href="{{ route('register') }}" class="btn btn-outline-dark w-100 rounded-pill py-2 fw-semibold">Mulai Gratis</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 reveal" style="transition-delay: 0.2s;">
                    <div class="pricing-card featured">
                        <div class="pricing-header">
                            ...
                            <h4>Premium</h4>
                            <div class="pricing-price">Rp 149.000<span>/undangan</span></div>
                            <p class="pricing-desc">Untuk pernikahan yang lebihPersonal</p>
                        </div>
                        <ul class="pricing-features">
                            <li><i class="bi bi-check-circle-fill text-gold"></i> Semua Tema Premium</li>
                            <li><i class="bi bi-check-circle-fill text-gold"></i> Unlimited tamu</li>
                            <li><i class="bi bi-check-circle-fill text-gold"></i> RSVP lengkap + analytics</li>
                            <li><i class="bi bi-check-circle-fill text-gold"></i> Galeri unlimited</li>
                            <li><i class="bi bi-check-circle-fill text-gold"></i> Hapus watermark</li>
                            <li class="disabled"><i class="bi bi-x-circle text-muted-custom"></i> Custom domain</li>
                        </ul>
                        <a href="{{ route('register') }}" class="btn btn-gold w-100 rounded-pill py-2 fw-semibold">Pilih Premium</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 reveal" style="transition-delay: 0.3s;">
                    <div class="pricing-card">
                        <div class="pricing-header">
                            <div class="pricing-icon"><i class="bi bi-crown"></i></div>
                            <h4>Exclusive</h4>
                            <div class="pricing-price">Rp 499.000<span>/undangan</span></div>
                            <p class="pricing-desc">Pengalaman undangan ultimate</p>
                        </div>
                        <ul class="pricing-features">
                            <li><i class="bi bi-check-circle-fill text-gold"></i> Semua fitur Premium</li>
                            <li><i class="bi bi-check-circle-fill text-gold"></i> Unlimited tamu</li>
                            <li><i class="bi bi-check-circle-fill text-gold"></i> RSVP + analytics lengkap</li>
                            <li><i class="bi bi-check-circle-fill text-gold"></i> Galeri unlimited</li>
                            <li><i class="bi bi-check-circle-fill text-gold"></i> Hapus watermark</li>
                            <li><i class="bi bi-check-circle-fill text-gold"></i> Custom domain + support 24/7</li>
                        </ul>
                        <a href="{{ route('register') }}" class="btn btn-outline-dark w-100 rounded-pill py-2 fw-semibold">Pilih Exclusive</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <table class="comparison-table">
                        ...
                        <tbody>
                            <tr>
                                <td>Pilihan Tema</td>
                                <td>5 Tema</td>
                                <td class="text-gold">Semua Tema</td>
                                <td>Semua Tema</td>
                            </tr>
                            <tr>
                                <td>Kapasitas Tamu</td>
                                <td>50</td>
                                <td class="text-gold">Unlimited</td>
                                <td>Unlimited</td>
                            </tr>
                            <tr>
                                <td>Galeri Foto</td>
                            ...
                            <tr>
                                ...
                                <td><i class="bi bi-x-circle text-muted-custom"></i></td>
                                <td class="text-gold"><i class="bi bi-check-circle-fill"></i></td>
                            ...
                            <tr>
                                <td>Support</td>
                                <td>Email</td>
                                <td class="text-gold">WhatsApp</td>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="faq-item reveal">
                        ...
                        <p>Tidak ada biaya tersembunyi. Semua yang tercantum adalah biaya final. Anda hanya membayar sesuai paket yang dipilih.</p>
                    </div>
                    <div class="faq-item reveal" style="transition-delay: 0.1s;">
                        ...
                        <p>Ya, Anda bisa upgrade kapan saja. Data undangan akan tetap tersimpan dan Anda hanya membayar selisih harga.</p>
                    </div>
