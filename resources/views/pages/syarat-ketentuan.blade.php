...
<head>
    ...
    <title>Syarat & Ketentuan - RuangUndang</title>
    ...
    <section class="content-section">
        <div class="container">
            <div class="text-center mb-5 reveal">
                ...
                <p class="section-desc">Dengan menggunakan layanan RuangUndang, Anda dianggap telah membaca dan
                    menyetujui semua syarat berikut.</p>
            </div>

            <div class="terms-list">
                <li class="reveal" style="transition-delay: 0.1s;">
                    <h5>1. Pendaftaran Akun</h5>
                    <p>Pengguna wajib mendaftarkan akun dengan data yang benar dan lengkap. Setiap pengguna bertanggung
                        jawab penuh atas aktivitas yang terjadi di akunnya. Dilarang mendaftar dengan identitas palsu
                        atau data orang lain.</p>
                </li>
                <li class="reveal" style="transition-delay: 0.15s;">
                    <h5>2. Layanan yang Disediakan</h5>
                    <p>RuangUndang menyediakan platform untuk membuat undangan digital pernikahan dan acara lainnya. Kami
                        berhak mengubah, menambah, atau menghapus fitur sewaktu-waktu tanpa pemberitahuan terlebih
                        dahulu.</p>
                </li>
                <li class="reveal" style="transition-delay: 0.2s;">
                    <h5>3. Hak Kekayaan Intelektual</h5>
                    <p>Semua tema, desain, dan konten yang tersedia di platform ini dilindungi oleh hak cipta. Pengguna
                        dilarang menyalin, mendistribusikan, atau menggunakan konten tersebut untuk komersial tanpa izin
                        tertulis dari RuangUndang.</p>
                </li>
                <li class="reveal" style="transition-delay: 0.25s;">
                    <h5>4. Konten Pengguna</h5>
                    <p>Pengguna bertanggung jawab atas semua konten yang diunggah. Dilarang mengunggah konten yang
                        melanggar hukum, bersifat SARA, pornografi, atau merugikan pihak lain. Kami berhak menghapus
                        konten tersebut tanpa pemberitahuan.</p>
                </li>
                <li class="reveal" style="transition-delay: 0.3s;">
                    <h5>5. Pembayaran dan Pembatalan</h5>
                    <p>Pembayaran untuk paket premium diproses melalui sistem yang aman. Pembatalan layanan dapat
                        dilakukan sebelum undangan aktif. Dana yang telah dibayarkan untuk paket premium tidak dapat
                        dikembalikan setelah undangan aktif dan digunakan.</p>
                </li>
                <li class="reveal" style="transition-delay: 0.35s;">
                    <h5>6. Batas Tanggung Jawab</h5>
                    <p>RuangUndang tidak bertanggung jawab atas kerugian akibat kegagalan sistem, force majeure, atau
                        kesalahan penggunaan oleh pengguna. Kami berusaha menjaga ketersediaan layanan sebaik mungkin.
                    </p>
                </li>
                <li class="reveal" style="transition-delay: 0.4s;">
                    <h5>7. Perubahan Syarat</h5>
                    <p>Kami berhak memperbarui syarat dan ketentuan ini sewaktu-waktu. Perubahan akan diumumkan di
                        halaman ini. Pengguna disarankan untuk memeriksa halaman ini secara berkala.</p>
                </li>
            </div>
        </div>
    </section>
    ...
    <section class="content-section alt">
        <div class="container">
            <div class="info-box reveal">
                ...
                <p>Jika Anda memiliki pertanyaan seputar syarat dan ketentuan ini, jangan ragu untuk menghubungi tim
                    support kami. Kami akan dengan senang hati membantu Anda memahami setiap poin yang tercantum di
                    atas.</p>
            </div>
