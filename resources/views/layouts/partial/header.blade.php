        ...
        <div class="container-fluid">
            ...
            <div class="ms-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-end width-300 pt-0 px-0">
                        ...
                        <div class="px-2">
                            <div class="row g-0 text-center mb-2">
                                ...
                                <!-- Dashboard -->
                                <div class="col-4">
                                    <a class="dropdown-item square-item"
                                ...
                                <div class="col-4">
                                    <a class="dropdown-item square-item"
                                        href="{{ auth()->user()->hasRole('admin') ? route('tempelate.index') : route('landing') . '#themes' }}">
                                        <div class="avatar avatar-40 rounded mb-2">
                                ...
                                <div class="col-4">
                                    <a class="dropdown-item square-item"
                                        href="{{ auth()->user()->hasRole('admin') ? route('music.index') : '#' }}">
                                        <div class="avatar avatar-40 rounded mb-2">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-end width-300 p-0 sm-mi-45px"
        ...
        <div class="row gx-2 align-items-center">
            ...
            <div class="col-auto">
                <div class="dropdown input-group-text border-0 p-0">
                    <button class="dropdown-toggle btn btn-link btn-square no-caret" type="button" id="searchfilter2"
                        ...
                        <ul class="nav adminuiux-nav" id="searchtab2" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="searchorders-tab2" data-bs-toggle="tab"
                                    ...
                                    aria-controls="searchorders2" aria-selected="false" tabindex="-1">Orders</button>
                            </li>
                            <li class="nav-item" role="presentation">
