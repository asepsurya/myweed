            ...
            <ul class="nav flex-column menu-active-line">
                ...
                @if(auth()->user()->hasFeature('budget_management'))
                    ...
                    $isSavingsActive = request()->routeIs('savings.*');
                                                            ?>
                        <li class="nav-item">
                            <a href="{{ route('weeding-plan.index') }}" class="nav-link " data-bs-toggle="collapse"
                                data-bs-target="#financeMenu" aria-expanded="{{ $isWeddingPlannerActive ? 'true' : 'false' }}"
                                aria-controls="financeMenu" role="button">
                            ...
                            <div class="collapse ps-3 {{ $isWeddingPlannerActive ? 'show' : '' }}" id="financeMenu">
                                ...
                                <a href="{{ route('budget.dashboard') }}" class="nav-link ps-4" data-bs-toggle="collapse"
                                    data-bs-target="#budgetMenu" aria-expanded="{{ $isBudgetActive ? 'true' : 'false' }}"
                                    aria-controls="budgetMenu" role="button">
                                ...
                                <a href="{{ route('savings.dashboard') }}" class="nav-link ps-4" data-bs-toggle="collapse"
                                    data-bs-target="#savingsMenu" aria-expanded="{{ $isSavingsActive ? 'true' : 'false' }}"
                                    aria-controls="savingsMenu" role="button">
                ...
                <li class="nav-item">
                    <a class="nav-link " data-bs-toggle="collapse" data-bs-target="#paymentMenu"
                        aria-expanded="{{ $isPaymentActive ? 'true' : 'false' }}" aria-controls="paymentMenu" role="button">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('logs.index') }}" data-bs-toggle="tooltip" data-bs-placement="right"
                        title="Log Viewer">
