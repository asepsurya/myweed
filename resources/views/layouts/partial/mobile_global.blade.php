...
@if(!request()->routeIs('invitation.edit*'))
    ...
    @if(request()->routeIs('weeding-plan.*', 'budget.*', 'savings.*', 'financial-overview.*'))
        <nav class="mobile-bottom-nav">
            ...
            <a href="{{ route('budget.dashboard') }}" class="nav-item {{ request()->routeIs('budget.*') ? 'active' : '' }}">
        ...
        <div class="more-menu" id="moreMenu">
            <div class="more-menu-content">
                ...
                <a href="{{ route('dashboard.user') }}"
                    class="more-item {{ request()->routeIs('dashboard.user') ? 'active' : '' }}">
                ...
                <a href="{{ route('documentation.index') }}"
                    class="more-item {{ request()->routeIs('documentation.index') ? 'active' : '' }}">
