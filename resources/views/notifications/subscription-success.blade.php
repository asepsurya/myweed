    ...
    <div class="email-container" style="max-width: 560px; margin: 0 auto; background: #FFFFFF; border-radius: 20px; overflow: hidden; box-shadow: 0 16px 40px rgba(0,0,0,0.06);">
        ...
        <div class="email-body" style="padding: 2rem 2.25rem 2.5rem;">
            ...
            <div style="text-align: center; margin-bottom: 2rem;">
                <img src="https://ruangundang.my.id/assets/logo-new.png" alt="RuangUndang Logo" style="max-width: 140px; height: auto; margin: 0 auto;">
            </div>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 1.5rem;">
                <tr>
                    <td valign="top" style="font-size: 0.95rem;">
                        ...
                        <p style="margin: 0.25rem 0 0 0; color: #5A6478;">Halo <strong style="color: #1B2A4A;">{{ $notifiable->name }}</strong>! Pembayaran Anda telah berhasil.</p>
                    </td>
            ...
            <table class="detail-table" width="100%" cellpadding="0" cellspacing="0" style="width: 100%; border-collapse: collapse; margin: 1rem 0;">
                <tr>
                    <td style="padding: 0.8rem 0; font-size: 0.95rem; border-bottom: 1px solid #E8E4DE; color: #6B7280; width: 40%;">Order ID</td>
                    <td style="padding: 0.8rem 0; font-size: 0.95rem; border-bottom: 1px solid #E8E4DE; font-weight: 600; text-align: right; color: #1B2A4A;">{{ $payment->order_id ?? '-' }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="padding: 0.8rem 0; font-size: 0.95rem; border-bottom: 1px solid #E8E4DE; color: #6B7280; width: 40%;">Jumlah</td>
                    <td style="padding: 0.8rem 0; font-size: 0.95rem; border-bottom: 1px solid #E8E4DE; font-weight: 600; text-align: right; color: #1B2A4A;">Rp {{ number_format($payment->amount ?? 0, 0, ',', '.') }}</td>
                </tr>
                <tr>
                    <td style="padding: 0.8rem 0; font-size: 0.95rem; border-bottom: 1px solid #E8E4DE; color: #6B7280; width: 40%;">Status</td>
                    <td style="padding: 0.8rem 0; font-size: 0.95rem; border-bottom: 1px solid #E8E4DE; text-align: right;">
                        <span style="display: inline-block; background: #10B981; color: #fff; padding: 0.25rem 0.75rem; border-radius: 9999px; font-size: 0.8rem; font-weight: 700;">{{ strtoupper($payment->status ?? 'PAID') }}</span>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 0.8rem 0; font-size: 0.95rem; color: #6B7280; width: 40%;">Durasi</td>
                    <td style="padding: 0.8rem 0; font-size: 0.95rem; font-weight: 600; text-align: right; color: #1B2A4A;">{{ $plan->duration }} hari</td>
                </tr>
            </table>

            <p style="margin: 1.5rem 0 0.5rem 0; color: #5A6478; line-height: 1.6; font-size: 0.9rem;">Invoice ini berfungsi sebagai bukti pembelian dan langganan Anda. Simpan invoice ini untuk keperluan referensi.</p>
