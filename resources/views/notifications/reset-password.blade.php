            ...
            <td align="center">
                <div class="email-container">
                    ...
                    <div class="email-header">
                        ...
                        <p class="email-description">We received a request to reset the password for your account. Click the button below to create a new password.</p>
                    </div>
                    ...
                    <div class="email-body">
                        ...
                        <p class="email-tip">
                            ...
                            This link will expire in {{ $expiryMinutes ?? 60 }} minutes.
                        </p>
                    </div>
