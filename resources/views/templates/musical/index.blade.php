...
<!-- Mirrored from wpocean.com/html/tf/love-love/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Jan 2026 00:00:49 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="wpOceans">
    <link rel="shortcut icon" type="image/png" href="{{ asset('tempelate/love/assets/images/favicon.png') }}">
    <title> LoveLove - Wedding & Wedding Planner HTML5 Template</title>
    <link href="{{ asset('tempelate/love/assets/css/themify-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/css/flaticon.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/css/animate.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/css/owl.carousel.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/css/owl.theme.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/css/slick.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/css/slick-theme.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/css/swiper.min.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/css/nice-select.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/css/owl.transitions.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/css/jquery.fancybox.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/css/odometer-theme-default.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/css/jquery-ui.css') }}" rel="stylesheet">
    <link href="{{ asset('tempelate/love/assets/sass/style.css') }}" rel="stylesheet">
</head>
...
<body>
   ...
   <!-- start page-wrapper -->
        ...
        <div class="preloader">
            <div class="vertical-centered-box">
                <div class="content">
                    ...
                    <img src="{{ asset('tempelate/love/assets/images/preloader.svg') }}" alt="">
                </div>
            </div>
        </div>
        <!-- end preloader -->
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 col-6 d-lg-none dl-block">
                                <div class="navbar-header">
                                    <a class="navbar-brand" href="index.html"><img src="{{ asset('tempelate/love/assets/images/logo.svg') }}"
                                            alt=""></a>
                                </div>
                            </div>
                                        ...
                                        <div class="mini-cart-content">
                                            ...
                                            <div class="mini-cart-items">
                                                <div class="mini-cart-item clearfix">
                                                    <div class="mini-cart-item-image">
                                                        <a href="shop.html"><img
                                                                src="{{ asset('tempelate/love/assets/images/shop/mini-cart/img-1.jpg') }}" alt></a>
                                                    </div>
                                                ...
                                                <div class="mini-cart-item clearfix">
                                                    <div class="mini-cart-item-image">
                                                        <a href="shop.html"><img
                                                                src="{{ asset('tempelate/love/assets/images/shop/mini-cart/img-2.jpg') }}" alt></a>
                                                    </div>
                                                    <div class="mini-cart-item-des">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="{{ asset('tempelate/love/assets/images/slider/slide-5.jpg') }}">
                        </div> <!-- end slide-inner -->
                    </div> <!-- end swiper-slide -->

                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="{{ asset('tempelate/love/assets/images/slider/slide-6.jpg') }}">
                        </div> <!-- end slide-inner -->
                    </div> <!-- end swiper-slide -->

                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="{{ asset('tempelate/love/assets/images/slider/slide-7.jpg') }}">
                        </div> <!-- end slide-inner -->
                    </div> <!-- end swiper-slide -->

                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="{{ asset('tempelate/love/assets/images/slider/slide-8.jpg') }}">
                        </div> <!-- end slide-inner -->
                    </div> <!-- end swiper-slide -->
                </div>
                <!-- end swiper-wrapper -->
        ...
        <section class="wpo-wedding-date">
            <div class="container">
                <h2 class="wow fadeInUp" data-wow-duration="1000ms">
                    <span class="shape-1"><img src="{{ asset('tempelate/love/assets/images/slider/shape.png') }}" alt=""></span>
                    {{ $invitation->bride_name }} & {{ $invitation->groom_name }}
                    <span class="shape-2"><img src="{{ asset('tempelate/love/assets/images/slider/shape2.png') }}" alt=""> </span>
                </h2>
                    ...
                    <div class="row align-items-center">
                        <div class="col col-md-5 col-12">
                            <div class="couple-item wow fadeInLeftSlow" data-wow-duration="1700ms">
                                <div class="couple-img">
                                    <img src="{{ asset('tempelate/love/assets/images/couple/img-1.png') }}" alt="">
                                </div>
                        ...
                        <div class="col col-md-2 col-12">
                            <div class="middle-couple-shape wow fadeInUp" data-wow-duration="1000ms">
                                <div class="shape">
                                    <img src="{{ asset('tempelate/love/assets/images/couple/shape.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col col-md-5 col-12">
                            <div class="couple-item wow fadeInRightSlow" data-wow-duration="1700ms">
                                <div class="couple-img">
                                    <img src="{{ asset('tempelate/love/assets/images/couple/img-2.png') }}" alt="">
                                </div>
                                <div class="couple-text">
                                    <h3>William Jack</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna orci auctor vitae
        ...
        <section class="wpo-video-section-s2 pb-0 section-padding">
            ...
            <div class="container">
                <div class="video-wrap">
                    <img src="{{ asset('tempelate/love/assets/images/cta2.jpg') }}" alt="">
            ...
            <div class="container-fluid">
                ...
                <div class="wpo-story-wrap">
                    <div class="wpo-story-item">
                        <div class="wpo-story-img-wrap">
                            <div class="wpo-story-img wow zoomIn" data-wow-duration="1000ms">
                                <img src="{{ asset('tempelate/love/assets/images/story/1.jpg') }}" alt="">
                            </div>
                            <div class="wpo-img-shape">
                                <img src="{{ asset('tempelate/love/assets/images/story/shape.png') }}" alt="">
                            </div>
                        </div>
                    ...
                    <div class="wpo-story-item">
                        <div class="wpo-story-img-wrap">
                            <div class="wpo-story-img wow zoomIn" data-wow-duration="1000ms">
                                <img src="{{ asset('tempelate/love/assets/images/story/2.jpg') }}" alt="">
                            </div>
                            <div class="wpo-img-shape">
                                <img src="{{ asset('tempelate/love/assets/images/story/shape.png') }}" alt="">
                            </div>
                    ...
                    <div class="wpo-story-item">
                        <div class="wpo-story-img-wrap">
                            <div class="wpo-story-img wow zoomIn" data-wow-duration="1000ms">
                                <img src="{{ asset('tempelate/love/assets/images/story/3.jpg') }}" alt="">
                            </div>
                            <div class="wpo-img-shape">
                                <img src="{{ asset('tempelate/love/assets/images/story/shape.png') }}" alt="">
                            </div>
                            ...
                            <div class="portfolio-grids gallery-container clearfix">
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="{{ asset('tempelate/love/assets/images/portfolio/10.jpg') }}" class="fancybox"
                                            data-fancybox-group="gall-1">
                                            <img src="{{ asset('tempelate/love/assets/images/portfolio/10.jpg') }}" alt class="img img-responsive">
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="{{ asset('tempelate/love/assets/images/portfolio/5.jpg') }}" class="fancybox"
                                            data-fancybox-group="gall-1">
                                            <img src="{{ asset('tempelate/love/assets/images/portfolio/5.jpg') }}" alt class="img img-responsive">
                                            <div class="hover-content">
                                                <i class="ti-plus"></i>
                                            </div>
                                        </a>
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="{{ asset('tempelate/love/assets/images/portfolio/6.jpg') }}" class="fancybox"
                                            data-fancybox-group="gall-1">
                                            <img src="{{ asset('tempelate/love/assets/images/portfolio/6.jpg') }}" alt class="img img-responsive">
                                            <div class="hover-content">
                                                <i class="ti-plus"></i>
                                            </div>
                                        </a>
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="{{ asset('tempelate/love/assets/images/portfolio/7.jpg') }}" class="fancybox"
                                            data-fancybox-group="gall-1">
                                            <img src="{{ asset('tempelate/love/assets/images/portfolio/7.jpg') }}" alt class="img img-responsive">
                                            <div class="hover-content">
                                                <i class="ti-plus"></i>
                                            </div>
                                        </a>
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="{{ asset('tempelate/love/assets/images/portfolio/8.jpg') }}" class="fancybox"
                                            data-fancybox-group="gall-1">
                                            <img src="{{ asset('tempelate/love/assets/images/portfolio/8.jpg') }}" alt class="img img-responsive">
                                            <div class="hover-content">
                                                <i class="ti-plus"></i>
                                            </div>
                                        </a>
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="{{ asset('tempelate/love/assets/images/portfolio/9.jpg') }}" class="fancybox"
                                            data-fancybox-group="gall-1">
                                            <img src="{{ asset('tempelate/love/assets/images/portfolio/9.jpg') }}" alt class="img img-responsive">
                                            <div class="hover-content">
                                                <i class="ti-plus"></i>
                                            </div>
                                        </a>
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="{{ asset('tempelate/love/assets/images/portfolio/11.jpg') }}" class="fancybox"
                                            data-fancybox-group="gall-1">
                                            <img src="{{ asset('tempelate/love/assets/images/portfolio/11.jpg') }}" alt class="img img-responsive">
                                            <div class="hover-content">
                                                <i class="ti-plus"></i>
                                            </div>
                                        </a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col col-xl-8 col-lg-6 col-md-12 col-12">
                        <div class="contact-img wow fadeInRightSlow" data-wow-duration="1700ms">
                            <img src="{{ asset('tempelate/love/assets/images/contact/img-4.jpg') }}" alt="">
                ...
                <div class="row">
                    <div class="col col-xs-12">
                        <div class="partner-grids partners-slider owl-carousel">
                            <div class="grid">
                                <img src="{{ asset('tempelate/love/assets/images/partners/1.png') }}" alt>
                            </div>
                            <div class="grid">
                                <img src="{{ asset('tempelate/love/assets/images/partners/2.png') }}" alt>
                            </div>
                            <div class="grid">
                                <img src="{{ asset('tempelate/love/assets/images/partners/3.png') }}" alt>
                            </div>
                            <div class="grid">
                                <img src="{{ asset('tempelate/love/assets/images/partners/4.png') }}" alt>
                            </div>
                            <div class="grid">
                                <img src="{{ asset('tempelate/love/assets/images/partners/5.png') }}" alt>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wpo-event-wrap">
                    <div class="row">
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-event-item">
                                <div class="wpo-event-img">
                                    <img src="{{ asset('tempelate/love/assets/images/event/1.jpg') }}" alt="">
                        ...
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-event-item">
                                <div class="wpo-event-img">
                                    <img src="{{ asset('tempelate/love/assets/images/event/2.jpg') }}" alt="">
                        ...
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-event-item">
                                <div class="wpo-event-img">
                                    <img src="{{ asset('tempelate/love/assets/images/event/3.jpg') }}" alt="">
                            ...
                            <div class="col-lg-12">
                                <div class="wpo-blog-grids gallery-container clearfix">
                                    <div class="grid">
                                        <div class="wpo-blog-item">
                                            <div class="wpo-blog-img">
                                                <img src="{{ asset('tempelate/love/assets/images/blog/img-1.jpg') }}" alt="">
                                            </div>
                                    ...
                                    <div class="grid">
                                        <div class="wpo-blog-item">
                                            <div class="wpo-blog-img">
                                                <img src="{{ asset('tempelate/love/assets/images/blog/img-2.jpg') }}" alt="">
                                            </div>
                                            <div class="wpo-blog-content">
                                    ...
                                    <div class="grid">
                                        <div class="wpo-blog-item">
                                            <div class="wpo-blog-img">
                                                <img src="{{ asset('tempelate/love/assets/images/blog/img-3.jpg') }}" alt="">
                                            </div>
                                            <div class="wpo-blog-content">
                                    ...
                                    <div class="grid">
                                        <div class="wpo-blog-item">
                                            <div class="wpo-blog-img">
                                                <img src="{{ asset('tempelate/love/assets/images/blog/img-4.jpg') }}" alt="">
                                            </div>
                                            <div class="wpo-blog-content">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="footer-image">
                            <a class="logo" href="index.html"><img src="{{ asset('tempelate/love/assets/images/logo.svg') }}" alt=""></a>
                        </div>
                    </div>
                    <div class="col-12">
    ...
    ================================================== -->
    <script src="{{ asset('tempelate/love/assets/js/jquery.min.js') }}"></script>
    <script src="{{ asset('tempelate/love/assets/js/bootstrap.bundle.min.js') }}"></script>
    <!-- Plugins for this template -->
    <script src="{{ asset('tempelate/love/assets/js/modernizr.custom.js') }}"></script>
    <script src="{{ asset('tempelate/love/assets/js/jquery.dlmenu.js') }}"></script>
    <script src="{{ asset('tempelate/love/assets/js/jquery-plugin-collection.js') }}"></script>
    <!-- Custom script for this template -->
    <script src="{{ asset('tempelate/love/assets/js/script.js') }}"></script>
</body>


<!-- Mirrored from wpocean.com/html/tf/love-love/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Jan 2026 00:01:10 GMT -->
</html>
