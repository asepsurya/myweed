...
<!-- MEMPELAI -->
            <div class="text-center animate-on-scroll px-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        <img loading="lazy"src="/storage/{{ $invitation->foto_pria }}" class="w-28 h-28 rounded-full mx-auto shadow" loading="lazy">
                    ...
                    <div>
                        <img loading="lazy"src="/storage/{{ $invitation->foto_wanita }}" class="w-28 h-28 rounded-full mx-auto shadow" loading="lazy">
