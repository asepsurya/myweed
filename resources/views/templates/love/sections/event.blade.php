      <!-- COUNTDOWN -->
            <div class="bg-primary/10 p-6 rounded-xl text-center animate-on-scroll px-6">
   ...
   <!-- LOCATION -->
            <div class="text-center animate-on-scroll px-6">
                ...
                <div class="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600 mb-2">Minggu, 12 Mei 2026</p>
                    <p class="text-sm text-gray-600 mb-3">Pukul 10:00 WIB</p>
                    <p class="text-sm text-gray-600 mb-3">Gedung Serbaguna</p>
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 mb-2">Minggu, 12 Mei 2026</p>
                    <p class="text-sm text-gray-600 mb-3">Pukul 13:00 WIB</p>
                    <p class="text-sm text-gray-600 mb-3">Gedung Serbaguna</p>
                    <a href="https://maps.google.com" target="_blank"
                        class="inline-block bg-primary text-white px-6 py-2 rounded-full text-sm">
                        Buka Maps
            ...
            <div class="relative h-[420px] w-full bg-cover bg-center flex items-center justify-center text-center"
                ...
                <div class="relative z-10 max-w-md text-white px-6">
                    <p class="italic font-serif text-lg leading-relaxed mb-3">
                        ...
                        pasangan untukmu agar kamu merasa tenteram."
                    </p>
