...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .session-alert.success { background: var(--success-bg); color: #166534; border-color: var(--success-border); }
        .session-alert.error   { background: var(--error-bg); color: #991B1B; border-color: var(--error-border); }
        ...
        .field-input:focus ~ .field-icon-left { color: var(--gold-dark); }

        .field.has-icon .field-input { padding-left: 2.75rem; }
        .field.has-icon .field-label { left: 2.75rem; }

        /* Valid */
        .field-input.is-valid { border-color: var(--success); background: var(--success-bg); }
        .field-input.is-valid:focus { box-shadow: 0 0 0 3px rgba(22,163,74,0.08); background: var(--white); }
        .field-input.is-valid + .field-label { color: var(--success); }
        .field-input.is-valid ~ .field-icon-left { color: var(--success); }

        /* Invalid */
        .field-input.is-invalid { border-color: var(--error); background: var(--error-bg); animation: shake 0.4s ease; }
        .field-input.is-invalid:focus { box-shadow: 0 0 0 3px rgba(220,38,38,0.08); background: var(--white); }
        .field-input.is-invalid + .field-label { color: var(--error); }
        .field-input.is-invalid ~ .field-icon-left { color: var(--error); }
        ...
        .field.has-toggle .field-input { padding-right: 2.75rem; }
        .field.has-toggle .field-icon-left { right: 2.75rem; }
        ...
        .pwd-strength-text i { font-size: 0.75rem; }
        ...
        .card-footer a:hover { color: var(--gold-dark); }
        .card-footer a:hover::after { width: 100%; }
        ...
        @keyframes toastIn  { from { opacity:0; transform:translateX(120%) scale(0.95); } to { opacity:1; transform:translateX(0) scale(1); } }
        @keyframes toastOut { from { opacity:1; transform:translateX(0) scale(1); } to { opacity:0; transform:translateX(120%) scale(0.95); } }

        /* ===== Responsive ===== */
        @media (max-width: 480px) {
            body { padding: 1rem; }
            .card-header { padding: 2rem 1.5rem 0; }
            .card-body    { padding: 1.75rem 1.5rem 0.5rem; }
            .card-footer  { padding: 1.25rem 1.5rem 1.75rem; }
            .card-header h1 { font-size: 1.3rem; }
            .card-header p { font-size: 0.84rem; }
            .field-input { height: 50px; font-size: 0.875rem; }
            .btn-submit { height: 50px; }
            .header-icon { width: 56px; height: 56px; font-size: 1.3rem; }
        }
