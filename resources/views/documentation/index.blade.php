<x-app-layout>
    @section('breadcrumb')
        <li class="breadcrumb-item">
            <a href="{{ route('dashboard.user') }}"><i class="bi bi-house-door me-1"></i> Dashboard</a>
        </li>
    ...
    <style>
        ...
        /* Menggunakan utility class bg-body-tertiary untuk pengganti .doc-step */
    </style>

    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
        <div>
            <h4 class="fw-bold mb-1">Dokumentasi Penggunaan</h4>
            ...
            <div class="row g-4">
                    ...
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-danger-subtle text-danger"><i class="bi bi-heart"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3 mb-2">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    ...
                                    <span class="small fw-semibold">Buat Data Pasangan</span>
                                </div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    ...
                                    <span class="small fw-semibold">Kelola & Edit</span>
                                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-info-subtle text-info"><i class="bi bi-calendar-check"></i></div>
                                <div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-success-subtle text-success"><i class="bi bi-calculator"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3 mb-2">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    ...
                                    <span class="small fw-semibold">Set Total Anggaran</span>
                                </div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    ...
                                    <span class="small fw-semibold">Buat Kategori</span>
                                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-warning-subtle text-warning"><i class="bi bi-piggy-bank"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3 mb-2">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    ...
                                    <span class="small fw-semibold">Buat Target Tabungan</span>
                                </div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    ...
                                    <span class="small fw-semibold">Catat Setoran</span>
                                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-primary-subtle text-primary"><i class="bi bi-bar-chart-line"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3 mb-2">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <div class="doc-badge bg-primary text-white">1</div>
                                    <span class="small fw-semibold">Review Ringkasan</span>
                                </div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <div class="doc-badge bg-primary text-white">2</div>
                                    <span class="small fw-semibold">Monitor Status</span>
                                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-secondary-subtle text-secondary"><i class="bi bi-clipboard-check"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3 mb-2">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    ...
                                    <span class="small fw-semibold">Lihat Ucapan</span>
                                </div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    ...
                                    <span class="small fw-semibold">Kelola RSVP</span>
                                </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-primary-subtle text-primary"><i class="bi bi-columns-gap"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <div class="doc-badge bg-primary text-white">1</div>
                                    <span class="small fw-semibold">Lihat Statistik</span>
                                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-primary-subtle text-primary"><i class="bi bi-gem"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <div class="doc-badge bg-primary text-white">1</div>
                                    <span class="small fw-semibold">Verifikasi & Edit</span>
                                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-primary-subtle text-primary"><i class="bi bi-music-note-list"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <div class="doc-badge bg-primary text-white">1</div>
                                    <span class="small fw-semibold">Upload & Edit Musik</span>
                                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-primary-subtle text-primary"><i class="bi bi-stars"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <div class="doc-badge bg-primary text-white">1</div>
                                    <span class="small fw-semibold">Generate dengan AI</span>
                                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-primary-subtle text-primary"><i class="bi bi-palette"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <div class="doc-badge bg-primary text-white">1</div>
                                    <span class="small fw-semibold">Upload Template</span>
                                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-primary-subtle text-primary"><i class="bi bi-tags"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <div class="doc-badge bg-primary text-white">1</div>
                                    <span class="small fw-semibold">Atur Paket</span>
                                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-primary-subtle text-primary"><i class="bi bi-ticket-perforated"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <div class="doc-badge bg-primary text-white">1</div>
                                    <span class="small fw-semibold">Buat Kupon</span>
                                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-primary-subtle text-primary"><i class="bi bi-megaphone"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <div class="doc-badge bg-primary text-white">1</div>
                                    <span class="small fw-semibold">Atur Promosi</span>
                                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-primary-subtle text-primary"><i class="bi bi-people"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <div class="doc-badge bg-primary text-white">1</div>
                                    <span class="small fw-semibold">Manage User</span>
                                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card adminuiux-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="doc-icon-box bg-primary-subtle text-primary"><i class="bi bi-sliders"></i></div>
                                <div>
                            ...
                            <div class="bg-body-tertiary rounded-3 p-3">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <div class="doc-badge bg-primary text-white">1</div>
                                    <span class="small fw-semibold">Konfigurasi</span>
                                </div>
