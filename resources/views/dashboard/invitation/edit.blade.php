    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mx-auto p-6 bg-white rounded-xl">
                ...
                <form method="POST" action="{{ route('invitation.update', $invitation) }}" enctype="multipart/form-data" class="" id="myForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="p-0 m-0">
                                ...
                                <div class="flex-1 p-6 bg-gray-50">
                                    ...
                                    <div class="tab-content" id="general">
                                        <div class="flex gap-6">
                                            ...
                                            <div class="flex-1 bg-green-100 p-6 rounded-lg">
                                                ...
                                                <div id="previewContainerGroom" class="mt-4 relative">
                                                    <img id="previewGroom" src="{{ asset('storage/' . $invitation->foto_pria) }}" class="w-full max-h-60 object-cover rounded-lg" alt="Preview Foto">
                                                    <center>
                                        ...
                                        <div class="flex gap-6">
                                            <div class="flex-1 flex flex-col gap-4">
                                                <div class="flex flex-col">
                                                    ...
                                                    <input type="text" id="bride_name" name="bride_name" value="{{ old('bride_name', $invitation->bride_name) }}" placeholder="Masukkan nama mempelai wanita" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                                </div>
                                                <div class="flex flex-col">
                                                    <label for="bride_nickname" class="mb-1 font-medium text-gray-700">Nama Panggilan</label>
                                                    <input type="text" id="bride_nickname" name="bride_nickname" value="{{ old('bride_nickname', $invitation->bride_nickname) }}" placeholder="Masukkan nama panggilan mempelai wanita" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                                </div>
                                                <div class="flex flex-col">
                                                    <label for="bride_father_name" class="mb-1 font-medium text-gray-700">Nama Ayah Kandung</label>
                                                    <input type="text" id="bride_father_name" name="bride_father_name" value="{{ old('bride_father_name', $invitation->bride_father_name) }}" placeholder="Masukkan nama lengkap ayah kandung mempelai wanita" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                                </div>
                                                <div class="flex flex-col">
                                                    <label for="bride_mother_name" class="mb-1 font-medium text-gray-700">Nama Ibu Kandung</label>
                                                    <input type="text" id="bride_mother_name" name="bride_mother_name" value="{{ old('bride_mother_name', $invitation->bride_mother_name) }}" placeholder="Masukkan nama lengkap ibu kandung mempelai wanita" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-1 bg-green-100 p-6 rounded-lg">
                                                ...
                                                <!-- Preview & Delete Button -->
                                                <div id="previewContainerBride" class="mt-4 relative">
                                                    <img id="previewBride" src="{{ asset('storage/' . $invitation->foto_wanita) }}" class="w-full max-h-60 object-cover rounded-lg" alt="Preview Foto">
                                                    <center>
                                    ...
                                    <div class="tab-content hidden" id="acara">
                                        ...
                                        <div class="flex flex-col mb-4">
                                            ...
                                            <input type="date" id="wedding_date" name="wedding_date" value="{{ old('wedding_date', $invitation->wedding_date) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                        </div>
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <div class="flex flex-col mb-3">
                                                ...
                                                <input type="text" id="akad_location" name="akad_location" value="{{ old('akad_location', $invitation->akad_location) }}" placeholder="Masukkan lokasi akad" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                            </div>

                                            <div class="flex flex-col">
                                                <label for="akad_time" class="mb-1 font-medium text-gray-700">Waktu Akad</label>
                                                <input type="time" id="akad_time" name="akad_time" value="{{ old('akad_time', $invitation->akad_time) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                            </div>

                                            <div class="flex flex-col mt-3">
                                                <label for="akad_maps" class="mb-1 font-medium text-gray-700">Link Maps</label>
                                                <input type="text" id="akad_maps" name="akad_maps" value="{{ old('akad_maps', $invitation->akad_maps) }}" placeholder="Masukkan link Google Maps" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <div class="flex flex-col mb-3">
                                                ...
                                                <input type="text" id="resepsi_location" name="resepsi_location" value="{{ old('resepsi_location', $invitation->resepsi_location) }}" placeholder="Masukkan lokasi resepsi" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                            </div>

                                            <div class="flex flex-col">
                                                <label for="resepsi_time" class="mb-1 font-medium text-gray-700">Waktu Resepsi</label>
                                                <input type="time" id="resepsi_time" name="resepsi_time" value="{{ old('resepsi_time', $invitation->resepsi_time) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                            </div>

                                            <div class="flex flex-col mt-3">
                                                <label for="resepsi_maps" class="mb-1 font-medium text-gray-700">Link Maps</label>
                                                <input type="text" id="resepsi_maps" name="resepsi_maps" value="{{ old('resepsi_maps', $invitation->resepsi_maps) }}" placeholder="Masukkan link Google Maps" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-content hidden" id="other">
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div class="flex flex-col">
                                                ...
                                                <textarea id="wedding_quote" name="wedding_quote" rows="4" placeholder="Masukkan kutipan untuk undangan" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('wedding_quote', $invitation->wedding_quote) }}</textarea>
                                            </div>

                                            <div class="flex flex-col">
                                                <label for="video_link" class="mb-1 font-medium text-gray-700">Link Video Pernikahan</label>
                                                <input type="text" id="video_link" name="video_link" value="{{ old('video_link', $invitation->video_link) }}" placeholder="Masukkan link video YouTube" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                            </div>

                                            <div class="flex flex-col">
                                                <label for="love_story" class="mb-1 font-medium text-gray-700">Cerita Cinta</label>
                                                <textarea id="love_story" name="love_story" rows="4" placeholder="Ceritakan perjalanan cinta kalian" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('love_story', $invitation->love_story) }}</textarea>
                                            </div>
                        ...
                        <div class="tab-content hidden" data-content="2">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="template_id" id="template_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent">
                                        ...
                                        <option value="{{ $template->id }}" {{ $invitation->template_id == $template->id ? 'selected' : '' }} data-image="{{ $template->image }}">{{ $template->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="mt-6">
                                ...
                                <div class="flex flex-wrap gap-3">
                                    ...
                                    <label class="relative flex items-center justify-center cursor-pointer">
                                        <input type="radio" name="theme_color" value="#1a365d" {{ $invitation->theme_color == '#1a365d' ? 'checked' : '' }} class="sr-only peer">
                         ...
                         transition-all hover:scale-110 relative" style="background-color: #1a365d;">
                                    ...
                                    <!-- Contoh 2 -->
                                    <label class="relative flex items-center justify-center cursor-pointer">
                                        <input type="radio" name="theme_color" value="#b91c1c" {{ $invitation->theme_color == '#b91c1c' ? 'checked' : '' }} class="sr-only peer">
                                        <span class="w-8 h-8 rounded-full border-2 border-gray-300
                         ...
                         transition-all hover:scale-110 relative" style="background-color: #b91c1c;">
                                    ...
                                    <!-- Contoh 3 -->
                                    <label class="relative flex items-center justify-center cursor-pointer">
                                        <input type="radio" name="theme_color" value="#166534" {{ $invitation->theme_color == '#166534' ? 'checked' : '' }} class="sr-only peer">
                                        <span class="w-8 h-8 rounded-full border-2 border-gray-300
                    ...
                    <div class="tab-content hidden" data-content="3">
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div id="gallery-preview" class="flex-1 flex overflow-x-auto gap-4 p-2 border rounded-lg bg-gray-50">
                               @if($invitation->galleries)
                                    @foreach(json_decode($invitation->galleries) as $image)
                                        <div class="flex-shrink-0 w-32 h-32 border border-gray-200 rounded-lg overflow-hidden relative" id="gallery-item-{{ $image->id }}">
                    ...
                    <div class="tab-content hidden" data-content="4">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="range" name="music_volume" min="0" max="100" value="{{ old('music_volume', $invitation->music_volume ?? 50) }}" class="w-full">
                    ...
                    <div class="tab-content hidden" data-content="5">
                        <div class="space-y-4">
                            <div class="flex items-center">
                                <input type="checkbox" id="enable_rsvp" name="enable_rsvp" {{ $invitation->enable_rsvp ? 'checked' : '' }} class="mr-2">
                                <label for="enable_rsvp" class="text-sm font-medium text-gray-700">Aktifkan RSVP</label>
                            </div>

                            <div id="rsvp_settings" class="space-y-4" style="{{ $invitation->enable_rsvp ? '' : 'display:none' }}">
                                <div>
                                    <label class="block text-sm font-semibold text-gray-900 mb-2">Batas Tanggal RSVP</label>
                                    <input type="date" name="rsvp_deadline" value="{{ old('rsvp_deadline', $invitation->rsvp_deadline) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent">
                                </div>

                                <div>
                                    <label class="block text-sm font-semibold text-gray-900 mb-2">Pesan Konfirmasi</label>
                                    <textarea name="rsvp_message" rows="4" placeholder="Terima kasih atas konfirmasi kehadiran Anda. Kami sangat menantikan kehadiran Anda di hari bahagia kami." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent">{{ old('rsvp_message', $invitation->rsvp_message) }}</textarea>
                                </div>

                                <div>
                                    <label class="block text-sm font-semibold text-gray-900 mb-2">Nomor WhatsApp untuk Notifikasi</label>
                                    <input type="text" name="rsvp_whatsapp" value="{{ old('rsvp_whatsapp', $invitation->rsvp_whatsapp) }}" placeholder="6281234567890" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent">
                                </div>
                            </div>
                        </div>
                    </div>
